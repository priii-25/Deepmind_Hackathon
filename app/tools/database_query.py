...
@tool(
    ...
    description=(
        ...
        "\n\nDo NOT use for: "
        "- Meeting transcripts or notes — delegate to agent_notetaker instead "
        "- Conversation history — use conversation_history tool or the summary in your context "
        ...
        "- calls (id, user_id, title, meeting_link, platform, status, start_time, end_time, "
        "  transcript, summary, action_items, meetingbaas_bot_id, tenant_id, created_at) "
